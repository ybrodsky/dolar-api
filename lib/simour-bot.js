...
const MESSAGES = {
  cron: {
    '9': [
      ...
      'Solo aca eh....',
      'un tema tranquilo para empezar el dia https://www.youtube.com/watch?v=5abamRO41fE ',
      [{
        msg: 'Augusto',
        delay: 0,
      }, {
      ...
      [{
        msg: '8:45 am ya me tocaron los huevos con un mail al mejor estilo siderca',
        delay: 0,
      }, {
        msg: 'tantas ganas tienen de que sea un lunes pija',
        delay: 10
      }],
    ],
    '16': [
  ...
  mentions: {
    ...
    U8Q8BSMQ9: [
      ...
      'que argentino que resultaste',
      [{
        msg: 'eraa tu rol en el viaje',
        delay: 0
      }, {
        msg: 'atar las cosas, mad dj skills',
        delay: 20,
      }, {
        msg: 'y guiarme',
        delay: 22,
      }, {
        msg: 'https://imgur.com/gallery/ISh6m67',
        delay: 25,
      }],
      'te vino Gerling?',
      'andas en minita',
  ...
  channels: {
    ...
    C8QPXKZPW: [
      ...
      [{
        msg: 'queres algo bueno... tenes que nacer hijo de rico',
        delay: 0,
      }, {
        msg: 'tipo los hijos de tinelli',
        delay: 5,
      }, {
        msg: 'y dps te la tiras de rebelde',
        delay: 10,
      }],
      [{
        msg: 'no es facil cambiar',
        delay: 0,
      }, {
        msg: 'no es facil reconocer el error propio y mejorar',
        delay: 5,
      }, {
        msg: 'paciencia',
        delay: 10,
      ...
      [
          'que asco una porno en 4k', 
          'tantos detalles innecesarios',
          { msg: 'fluidos, poros', delay: 10 },
      ],
      'llego a casa y me hago un batido de proteina',
      [{
        msg: 'que lleno de manjares que esta gesell',
        delay: 0,
      }, {
        msg: 'de manjares y de cautriciclos',
        delay: 5,
      }, {
        msg: 'y de manjares en cuatriciclo',
        delay: 7,
      }],
      [{
        msg: 'Pinche el colchon.... la primer noche, colchon pija',
        delay: 0,
      }, {
        msg: 'mi puteada tipo 2 am fue: colchon pija, te aguantas a gerling y te venis a pinchara ahora',
        delay: 5
      }],
      [{
        msg: 'me paso por el saco de los huevos al resto del mundo jajaja',
        delay: 0,
      }, {
        msg: 'me he cansado de putear el sagrado imen de la virgen maria frente a todos',
        delay: 5
      }],
      [{
        msg: 'yo tengo ganas de estar pescando o tirado abajo de un arbol, afilando un cuchillo',
        delay: 0,
      }, {
        msg: 'al pedo, pero afilandolo',
        delay: 5
      }],
      [{
        msg: 'esta vida',
        ...
        msg: 'que quita y que da',
        delay: 5
      }, {
        msg: 'easy comes, easy goes',
        delay: 10,
      }],
      [{
        msg: 'el otro dia con mica compramos un pan lactal don yeyo para hacer unos sanguchitos en la playa',
        delay: 0,
      }, {
        msg: 'es aserrin apelmasado',
        delay: 5
      }],
      [{
        msg: 'no se porque te ofendes cuando digo que los de contabilidad de siderca son imbeciles',
        delay: 0,
      }, {
        msg: 'uno de ellos es la gorda lorena, la que viajaba con nosotros y la rajaron de todos los grupos de viaje por idiota ',
        delay: 10
      }],
      [{
        msg: 'podes cree que me llamaron cuando estaba comiendo',
        delay: 0,
      }, {
        msg: 'me re cago en los de contabilidad',
        delay: 10
      }],
      'por que mejor no me palmeas las bolas hasta que suenen como el feliz cumpleaños?',
    ],
